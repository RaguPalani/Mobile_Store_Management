...
export const getProducts = (keyword, price, category, brand, currentPage) => async (dispatch) => {
...
export const getReviews =  name => async (dispatch) => {

    try {  
        dispatch(reviewsRequest()) 
        const { data }  =  await axios.get(`/api/v1/admin/reviews`,{params: {name}});
...
export const deleteReview =  (productId, name) => async (dispatch) => {

    try {  
        dispatch(deleteReviewRequest()) 
        await axios.delete(`/api/v1/admin/review`,{params: {productId, name}});
