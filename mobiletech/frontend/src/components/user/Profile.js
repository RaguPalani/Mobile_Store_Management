    ...
    return (
        <div className="row justify-content-around mt-5 user-info">
            ...
            <div className="col-12 col-md-5">
                ...
                {user.role !== 'admin' ? (
                    <Link to="/orders" className="btn btn-danger btn-animate btn-block mt-5">
                        My Orders
                    </Link>
                ) : null}
                
                <Link to="/myprofile/update/password" className="btn btn-primary btn-animate btn-block mt-3">
                    Change Password
                </Link>
            </div>
        </div>
