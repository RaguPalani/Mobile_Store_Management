...
export default function Cart() {
    // Getting cart items from cartState and authentication state from userState
    const { items } = useSelector(state => state.cartState);
    const { isAuthenticated } = useSelector(state => state.userState); // Check if user is authenticated
